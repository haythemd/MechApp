...
class _ProfileViewMobileState extends State<ProfileViewMobile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: MechWidgets.appBar(title: s.profileTitleText, context: context,showBackButton: false),
      body: BlocBuilder<ProfileBloc,ProfileState>(
          builder: (context, state) {
            ...
            return Padding(
              ...
              child: Column(
                children: [
                  SubtitleWidget(title:
                  s.profileIntegrationsText),
                  const SizedBox(
                    height: 10,
                  ),
                  // ClipRRect(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...state.profileModel.integrations.map((e) =>  MarketingPlatformIntegrationWidget(
                          imagePath: 'assets/icons/${e.platform.toLowerCase()}.svg',
